    ...
    <main class="container px-5">
        <div class="row border p-5 mt-5">
            ...
            <div class="col-sm-12">
                    ...
                    <p>Dans une prmeière variable je stock le mot 'Bonjour', et dans une deuxième le mot 'Madame', afin d'afficher la pharase compléte je concaténe les deux variable avec un point (.) (ex : voir le code sur VS code)</p>
                    <div class="alert alert-primary w-50">
                            <?php
                                $mot1 = "Bonjour";
                                $mot2 = "madame !";
            ...
            <div class="col-sm-12">
                ...
                <p>Une constante permet de conserver une valeur sauf que celle-ci ne peut pas changer. C'est à dire qu'on ne pourra pas la modifier durant l'exécution du script. Utile par exemple pour conserver les paramétres de connexion à la BDD de façon certaine. </p>
