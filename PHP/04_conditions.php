  ...
  <main class="container-fluid px-5">
    <div class="row">
        <div class="col-sm-12">
            ...
            if ($a > $b) { // si la condition est vrai, c'est-à-dire $a est supérieure à $b, alors on exécute les instructions entre les accolades
...
echo '<br>';
            if ($a > $c) { 
                ...
                // echo '<h2>Condition multiples avec if, else if et else</h2>';
echo '<hr>';
            ?>
...
echo '<hr>';
            ...
            $a = 11;
            echo ($a == 10) ? "\$a est égal à 10" : "\$a est différent de 10 <br>"; // Dans la condition ternaire le "?" remplace le "if" et les ":" remplace else, Ainsi si $a est égal à 10, on affiche la premiére expression sinon la deuxiéme.
echo '<hr>';
...
echo '<hr>';
            ...
            <?php 
                    if ($a == 9 || $b > $c) { // true
                        echo "<p class=\"alert alert-info\"> Une des deux conditions est vraie, le code renvoie true et le if s'exécute</p>";
                    }else{ 
...
echo '<hr>';
                ...
                <?php
                    ...
                    if ($varA == $varB) { // la condition est vrai car en valeur 1 et '1' sont équivalents
                        ...
                        // echo $varA + $varB ;  // L'Opération est possible
                    }else {
...
echo '<br>';
                    ...
                    if ($varA === $varB) { // la condition est fausse car 1 et '1' sont différents en type
                        ...
                        // echo $varA + $varB ;  // L'opération n'est pas possible
