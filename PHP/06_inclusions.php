...
<head>
  ...
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.1/dist/css/bootstrap.min.css" rel="stylesheet"
    ...
    <title>Cours PHP - Les importations</title>
  ...
  <main class="container-fluid px-5">
    <div class="row">
        ...
        <div class="col-sm-12 mt-5">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6">
                    <h3 class="tex-center text-primary">Include()</h3>

                    <?php
                        /* On va créer un dossier inc à la racine de notre dossier php 
                        dans ce dossier inc on vas créer un fichier test1.inc.php 
                        on crée une balise p avec une phrase : ceci est le premier fivhier d'inclusion 
                      */ 
                     include("inc/test1.inc.php");
                     include("inc/test1.inc.php");
                    ?>
                    <p>Ici nous avons inclus notre fichier test1.inc.php  grâce à la fonction <code>include</code>. Cette fonction prendra comme seul argument le chemin de notre fichier. Nous remarquons ici deux syntaxes possibles pour chacune d'elles. Les parenthèses sont facultatives. 
                    </p>
                </div>
                <div class="col-sm-12 col-md-6">
                    <h3 class="tex-center text-primary">Include_once()</h3>

                    <?php
                    /* 
                        Dans ce dossier on va créer un fichier test2.inc.php 
                        On crée une balise "p" avec une phrase : Ceci est le deuxiéme fichier d'inclusion.
                    */ 
                    include_once("inc/test2.inc.php");
                    include_once "inc/test2.inc.php";

                    ?>
                    <p>Ici nous avons inclus notre fichier test2.inc.php grâce à la fonction <code>include_once()</code>. Cette fonction prendra comme seul argument le chemin de notre fichier. Cette fonction permet d'importer une fois seulement un fichier même s'il y'a plusieurs tentatives d'importation du fichier dans la page.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-12 mt-5">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <h3 class="tex-center text-primary">Require()</h3>
                            <?php
                            /* On va créer un fichier test3.inc.php 
                            dans le dossier inc on créer une balise"p"avec la phrase : Ceci est le premier fichier d'inclusion avec reqire
                             */
                            require("inc/test3.inc.php");
                            require "inc/test3.inc.php";

                            ?>
                            <p>Ici nous avons inclus notre fichier test3.inc.php  grâce à la fonction <code>require</code>. Cette fonction prendra comme seul argument le chemin de notre fichier.Nous remarquons aussi deux syntaxes possibles pour chacune d'elles. Les parenthèses sont facultatives.
                            </p>
                        ...
                        <div class="col-sm-12 col-md-6">
                             ...
                             * On crée une balise p avec une phrase : Ceci est le deuxième fichier d'inclusion require_once
                             */
